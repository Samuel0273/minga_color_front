...
export default function Welcome() {
  return (
    <div className="bg-[url('/src/assets/img/fondomobile.png')] bg-cover bg-no-repeat bg-center  flex flex-col justify-center items-center text-white w-full h-screen px-5 mx-auto md:mt-5 md:mb-10 md:h-44 lg:h-56 md:rounded-lg md:px-8 md:items-start md:flex-grow">
